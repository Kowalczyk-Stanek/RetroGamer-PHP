...
?>
  ...
  <div class="mb-3">
    <label for="imie" class="form-label">E-mail</label>
    <input type="email" class="form-control" id="imie" name="e-mail">
  </div>
        <br>
  <div class="mb-3">
...
<select class="form-select" aria-label="Default select example" name="dostawa" required>
  ...
  <div class="mb-3 form-check">
    <input type="hidden" class="newsletter" id="newsletter" name="newsletter" value="0">
  </div>
        <br>
  <button type="submit" class="btn btn-primary">Zapłać i zamów</button>
    <a href="logout.php" class="btn btn-danger">Cofnij</a>
</form>
